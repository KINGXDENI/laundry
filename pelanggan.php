                ...
                <div class="page-content">
                    <section class="row">
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <a href="pelanggan_tambah.php" class="btn btn-primary btn-md mb-3">Tambah <i class="bi bi-plus"></i></a>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><img src="../uploads/<?php echo $hasil['Foto']; ?>" alt="Foto Pelanggan" width="100"></td>
                                                        ...
                                                        <td style="text-align: center;">
                                                            ...
                                                            <a href="javascript:void(0)" class="btn btn-danger delete-btn" onclick="confirmDelete('<?php echo $hasil['No_Identitas']; ?>')"><i class="bi bi-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                    $i++;
