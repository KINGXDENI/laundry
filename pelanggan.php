                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="tombol mb-3">
                                    <a href="tambahdatapelanggan.php"><button type="button"
                                            class="btn btn-success btn-md">Tambah Data</button></a>
                                </div>
                      ...
                      ?>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <a href="editdatapelanggan.php?edit=<?php echo $hasil['No_Identitas']; ?>"
                                                    class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                                                <a href="#" class="btn btn-danger delete-btn"
                                                    data-id="<?php echo $hasil['No_Identitas']; ?>"
                                                    onclick="confirmDelete(<?php echo $hasil['No_Identitas']; ?>)"><i
