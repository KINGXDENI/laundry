...
<head>
    ...
    <link rel="shortcut icon" href="./home/img/favicon/android-chrome-192x192.png" type="image/x-icon">
    <link rel="shortcut icon" href="./home/img/favicon/android-chrome-512x512.png" type="image/x-icon">
    <link rel="shortcut icon" href="./home/img/favicon/apple-touch-icon.png" type="image/x-icon">
    <link rel="shortcut icon" href="./home/img/favicon/favicon-16x16.png" type="image/x-icon">
    <link rel="shortcut icon" href="./home/img/favicon/favicon-32x32.png" type="image/x-icon">
...
<body>
    ...
    <nav class="navbar navbar-dark bg-inverse bg-inverse-custom navbar-fixed-top">
        <div class="container">
            ...
            <div id="collapsingMobileUser"
                class="collapse navbar-toggleable-custom dropdown-menu-custom p-x-1 hidden-md-up" role="tabpanel"
                aria-labelledby="collapsingMobileUser">
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
        <div class="container">
            <h1 class="display-3">Amanah Laundry </h1>
            <h2 class="m-b-3">Bersih, <em>Wangi</em>, dan Ekonomis <br><a href="ui-elements.html" class="jumbolink"></a>
            </h2>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="media">
                        ...
                        <small class="media-body media-bottom">
                            &copy; Laundry 2024. <br>
                            Designed by Amanah Laundry
                        </small>
                    </div>
                </div>
