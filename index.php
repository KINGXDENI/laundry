...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto">
                ...
                <img src="../asset/img/svg/amanah_logo.svg" width="40" height="auto" class="d-inline-block align-top" alt="Amanah Logo">
                <h1 class="sitename">manah Laundry</h1>
            </a>
    ...
    <main class="main">
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
                        <h1>Selamat Datang di Amanah Laundry!</h1>
                        <p>Layanan Laundry Terpercaya dan Berkualitas </p>
                        <div class="d-flex">
        ...
        <section id="services" class="services section light-background">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Services</h2>
                <p>Berbagai Layanan Laundry yang Kami Tawarkan</p>
            </div><!-- End Section Title -->
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="Login/index.php" class="stretched-link">Cuci Kering</a></h4>
                            <p>Layanan mencuci pakaian tanpa pengeringan.</p>
                        </div>
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="Login/index.php" class="stretched-link">Cuci Setrika</a></h4>
                            <p>Layanan mencuci dan menyetrika pakaian.</p>
                        </div>
                    </div><!-- End Service Item -->
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="Login/index.php" class="stretched-link">Setrika Saja</a></h4>
                            <p>Layanan menyetrika pakaian yang sudah dicuci.</p>
                        </div>
                    </div><!-- End Service Item -->
                    ...
                    <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
                        <div class="service-item position-relative">
                            ...
                            <h4><a href="Login/index.php" class="stretched-link">Antar Jemput</a></h4>
                            <p>Layanan antar jemput pakaian untuk mencuci.</p>
                        </div>
                    </div><!-- End Service Item -->
        ...
        <section id="call-to-action" class="call-to-action section dark-background">
            ...
            <img src="./landing-page/assets/img/cta-bg.jpg" alt="">
