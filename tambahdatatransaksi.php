                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-2">
                                <div id="pesan"></div>
                                <div class="tombol">
                                    <button type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#ModalTambah">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="proses-hapus-detail-transaksi.php?order=<?php echo $hasil['No_Order']; ?>&pakaian=<?php echo $hasil['Id_Pakaian']; ?>" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php
                                                $i++;
