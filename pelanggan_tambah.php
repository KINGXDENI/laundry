...
<body>
            ...
            <div class="page-content">
                <section class="row">
                    <div class="container">
                        <div class="card mt-2">
                            <div class="card-body">
                                <form action="pelanggan_proses_tambah.php" method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(event) {
            ...
            var alamat = document.querySelector('input[name="Alamat"]').value.trim();
            var noHp = document.querySelector('input[name="No_Hp"]').value.trim();
            var foto = document.querySelector('input[name="Foto"]').files.length;

            if (!nama || !email || !alamat || !noHp || !foto) {
                event.preventDefault();
                alert('Semua field harus diisi dan foto harus di-upload.');
            }
        });
    });
    </script>
